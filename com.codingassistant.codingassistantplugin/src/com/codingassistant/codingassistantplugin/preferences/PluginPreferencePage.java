package com.codingassistant.codingassistantplugin.preferences;
...
public class PluginPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public PluginPreferencePage() {
		...
		copilotPreferences = new ScopedPreferenceStore(InstanceScope.INSTANCE, "com.codingassistant.codingassistantplugin");
	...
	protected void createFieldEditors() {
		...
		String[][] backendOptions = { { "Fauxpilot", "com.codingassistant.codingassistantplugin.connection.fauxpilot.FauxpilotConnection" }, { "Tabby", "com.codingassistant.codingassistantplugin.connection.tabby.TabbyConnection" } };
		...
		authorizationTokenEditor.setEnabled(copilotPreferences.getString("BACKEND").equals("com.codingassistant.codingassistantplugin.connection.tabby.TabbyConnection"), fieldEditorParent);
		...
		propertyListener = event -> {
			...
			case "BACKEND": {
				...
				System.out.println(backend.equals("TabbyConnection"));
				authorizationTokenEditor.setEnabled(backend.equals("com.codingassistant.codingassistantplugin.connection.tabby.TabbyConnection"), getFieldEditorParent());
			}
