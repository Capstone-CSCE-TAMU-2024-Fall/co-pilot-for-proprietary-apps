...
public class FauxpilotConnection extends BackendConnection {
	...
	@Override
	public CompletableFuture<HttpResponse<String>> getResponse(String prefix, String suffix) throws JsonProcessingException {
	...
	@Override
	public <T extends BackendResponse> CompletableFuture<T> parseResponse(CompletableFuture<HttpResponse<String>> response) {
